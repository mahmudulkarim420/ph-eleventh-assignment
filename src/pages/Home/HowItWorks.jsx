  ...
  return (
    <section className="py-20 px-6 md:px-5 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
        {steps.map((step, idx) => (
          <div key={idx} className="bg-[#F9BC60] p-6 rounded-2xl text-center hover:shadow-xl transition duration-300">
            <div className="text-[#004643] w-8 mx-auto mb-4">{step.icon}</div>
