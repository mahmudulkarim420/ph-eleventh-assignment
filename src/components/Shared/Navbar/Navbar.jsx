        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `px-2 pb-1 transition font-medium ${
              isActive ? "text-white border-b-2 border-white" : "text-[#004643] hover:text-white"
            }`
          }
        >
          Home
  ...
  return (
    <div className="navbar backdrop-blur-md bg-[#F9BC60] border-b border-white/10 text-white shadow-md sticky top-0 z-50">
      <div className="navbar-start">
        <Link to="/" className="text-2xl font-bold text-[#004643]">
          StyleDecor
        </Link>
      </div>
      ...
      <div className="navbar-center hidden md:flex">
        <ul className=" menu-horizontal gap-6">{navLinks}</ul>
      </div>
      ...
      <div className="navbar-end gap-3">
        {user ? (
          ...
          <Link to="/login" className="btn bg-[#004643] text-[#F9BC60] btn-sm px-5">
            Login
          </Link>
        )}
